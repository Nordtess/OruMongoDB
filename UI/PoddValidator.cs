...
namespace UI
{
 // Flyttad till presentationslagret enligt krav: formell validering finns nära UI.
 ...
 if (name.Length >100)
 throw new ValidationException("Category name is too long (max100 characters).");
 }
