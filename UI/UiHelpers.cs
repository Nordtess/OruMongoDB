...
namespace UI
{
 ...
 { g.BackColor = panelBg; g.ForeColor = textGray; }
 foreach (var lbl in labels)
 { lbl.ForeColor = textGray; }
 foreach (var tb in textBoxes)
 { tb.BackColor = panelBg; tb.ForeColor = textWhite; tb.BorderStyle = BorderStyle.FixedSingle; }
 foreach (var lb in listBoxes)
 { lb.BackColor = bg; lb.ForeColor = textWhite; lb.BorderStyle = BorderStyle.FixedSingle; }
 foreach (var cb in comboBoxes)
 { cb.BackColor = panelBg; cb.ForeColor = textWhite; cb.FlatStyle = FlatStyle.Flat; }
